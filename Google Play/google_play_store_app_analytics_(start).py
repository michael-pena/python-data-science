...
Original file is located at
    https://colab.research.google.com/drive/1GPaB_mAWxspXawy8LkwPCQIQE-Y9oYs9
...
# remove the commas and turn the object data types into numerics for the Installs column
...
# get number of apps per category / number of occurences per unique value in a column
...
print(f'The dimensions of the DF are {cat_merged_df.shape}')
